...
const genres = [
    ...
    "j-rock", "jazz", "k-pop", "kids", "latin", "latino", "malay", "mandopop", "metal", "metal-misc", "metalcore", "minimal-techno",
    "movies", "mpb", "new-age", "new-release", "opera", "pagode", "party", "philippines-opm", "piano", "pop", "pop-film",
    "post-dubstep", "power-pop", "progressive-house", "psych-rock", "punk", "punk-rock", "r-n-b", "rainy-day", "reggae",
...
const GenreSearch = ({
    ...
    <div align='center'>
        <Autocomplete
            ...
            style={{ width: 300 }}
            renderInput={params => (
                <TextField {...params} label="Search for genre..." variant="filled" fullWidth />
            )}
        />
    </div>
);
